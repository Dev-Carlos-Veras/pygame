...
class Level:
        ...
        for row_index, row in enumerate(layout):
            for col_index, val in enumerate(row):
                ...
                if val == "1":
                    ...
                    sprite = tiles.StaticBlock((tile_size, tile_size), x, y, end_surface)
            ...
            for col_index, val in enumerate(row):
                if val != "-1":
                    ...
                    match type:
                        ...
                        case "enemy":
                            sprite = Enemy(32, 16, x, y, "/home/carlitos/Projects/Pygame/game_v3/graphics/enemy")
    ...
    def run(self):
        ...
        self.constraints_sprites.draw(self.map_surface)
